...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3">Laporan <strong>Pembayaran Utang</strong></h1>
                    ...
                    <div class="card-body">
                        <table class="table table-hover table-sm table-bordered">
                            <tr class="table-active text-center">
                                ...
                                <th>Supplier</th>
                                <th>Jumlah</th>
                                <th class="d-none d-md-table-cell">Transaksi</th>
                                <th class="d-none d-md-table-cell">Keterangan</th>
                                <th>Opsi</th>
                            </tr>
                            <tr class="text-center">
                                <td>1</td>
                                <td class="d-none d-md-table-cell">BU0023</td>
                                <td>2022-06-10</td>
                                <td class="text-start">Gia Supplier Boiler</td>
                                <td class="text-end">750,000</td>
                                <td class="d-none d-md-table-cell text-start">Belanja Bahan</td>
                                <td class="d-none d-md-table-cell text-start">Ayam Boiler 10 ekr</td>
                                <td>
                            ...
                            <tr class="text-center">
                                <td>2</td>
                                <td class="d-none d-md-table-cell">BU0873</td>
                                <td>2022-06-12</td>
                                <td class="text-start">DN Sejahtera</td>
                                <td class="text-end">800,000</td>
                                <td class="d-none d-md-table-cell text-start">Belanja Bahan</td>
                                <td class="d-none d-md-table-cell text-start">Tepung terigu 5 krg</td>
                                <td>
                                    <a href="#" class="btn btn-sm btn-danger"><span data-feather="trash"></span></a>
                                </td>
                            </tr>
                            <tr class="text-center">
                                <td>1</td>
                                <td class="d-none d-md-table-cell">BU0912</td>
                                <td>2022-06-12</td>
                                <td class="text-start">Umum</td>
                                <td class="text-end">50,000</td>
                                <td class="d-none d-md-table-cell text-start">Belanja Bahan</td>
                                <td class="d-none d-md-table-cell text-start">Sayuran</td>
                                <td>
                                    <a href="#" class="btn btn-sm btn-danger"><span data-feather="trash"></span></a>
                                </td>
                            </tr>
