...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3">Laporan <strong>Produksi</strong></h1>
                        ...
                        <form action="" method="post">
                            <div class="input-group col-12 col-lg-4">
                                ...
                                <select type="text" class="form-select" name="cari" id="cari" placeholder="Pencarian" autocomplete="off" style="max-width:50%;" onchange>
                                    ...
                                    <option>2022000539 - ATPS 10</option>
                                    <option>2022000542 - ATPS 6</option>
                                    <option>2022000525 - ATPS P12</option>
                                    <option>2022000555 - ATPS AH</option>
                                </select>
                    ...
                    <div class="card-body">
                        <table class="table table-hover table-sm table-bordered">
                            ...
                            <tr class="text-center">
                                <td>1</td>
                                <td>2022-06-20</td>
                                <td class="d-none d-md-table-cell">PR0923</td>
                                <td>2022000555</td>
                                <td>10</td>
                            ...
                            <tr class="text-center">
                                <td>2</td>
                                <td>2022-06-21</td>
                                <td class="d-none d-md-table-cell">PR0990</td>
                                <td>2022000568</td>
                                <td>2</td>
                            ...
                            <tr class="text-center">
                                <td>3</td>
                                <td>2022-06-25</td>
                                <td class="d-none d-md-table-cell">PR1233</td>
                                <td>2022000533</td>
                                <td>10</td>
                                <td class="text-end">150,000</td>
                                <td>-</td>
