...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3">Laporan <strong>Pembelian Item</strong></h1>
                        ...
                        <form action="" method="post">
                            <div class="input-group col-12 col-lg-4">
                                ...
                                <select type="text" class="form-select" name="cari" id="cari" placeholder="Pencarian" autocomplete="off" style="max-width:50%;" onchange>
                                    <option value="">.. item bahan ..</option>
                                    <option>Ayam Marinasi</option>
                    ...
                    <div class="card-body">
                        <table class="table table-hover table-sm table-bordered">
                            <tr class="table-active text-center">
                                ...
                                <th>Member</th>
                                <th class="d-none d-md-table-cell">Nama Bahan</th>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="d-none d-md-table-cell text-start">Ayam Marinasi</td>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="d-none d-md-table-cell text-start">Merica</td>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="d-none d-md-table-cell text-start">Tepung terigu</td>
                                <td class="d-none d-md-table-cell text-end">10,000</td>
                                <td>10</td>
